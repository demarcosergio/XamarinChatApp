...
namespace Crosschat.Client.Droid.Infrastructure
{
    public class InvitationSender : IContactInvitationSender
    {
        public void Send(Contact contact)
        {
            ...
            //    email.PutExtra(Intent.ExtraText, "Check this out: https://github.com/SergioBo/CrossChat-Xamarin.Forms");
            //    email.SetType("message/rfc822");
            //    Forms.Context.StartActivity(email);
            //}
            SmsManager.Default.SendTextMessage(contact.Number, null, "Check this out: https://github.com/SergioBo/CrossChat-Xamarin.Forms", null, null);
        }
    }
}
